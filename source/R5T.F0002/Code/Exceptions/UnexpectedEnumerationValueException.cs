...
namespace R5T.F0002
{
        ...
        where TEnum : Enum
    {
            ...
            : base(info, context)
        {
            ...
            this.Value = Instances.EnumerationHelper.GetValue<TEnum>(valueStringRepresentation);
        }
        ...
        public UnexpectedEnumerationValueException(TEnum value)
            : this(Instances.EnumerationHelper.UnexpectedEnumerationValueMessage(value))
        {
            this.Value = value;
        }
